...
public class Graphic {
	...
	public static void drawDino(Graphics g) {
		...
		if (Main.inGame)
			if (Dino.rightLegUp)
				g.drawImage(Dino.dinoright, (int) (Sets.width * 0.1) - 2,
						(int) (Sets.height * 0.58) - Dino.nowBounceHeight, Sets.PIXEL * 20, Sets.PIXEL * 22 - 1, null);
			else
				g.drawImage(Dino.dinoleft, (int) (Sets.width * 0.1), (int) (Sets.height * 0.58) - Dino.nowBounceHeight,
						Sets.PIXEL * 20 + 1, Sets.PIXEL * 22, null);
		else
			g.drawImage(Dino.dinodead, (int) (Sets.width * 0.1) - 2, (int) (Sets.height * 0.58) - Dino.nowBounceHeight,
					Sets.PIXEL * 20, Sets.PIXEL * 22 + 17, null);
	}
